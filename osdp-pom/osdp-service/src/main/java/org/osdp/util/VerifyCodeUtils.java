package com.tuniu.ngsp.tnc.controller;
...
public class VerifyCodeUtils {
	 ...
	 * @throws IOException
	 */
	public static String defaultVerifyImage(File outputFile) throws IOException {
		String verifyCode = generateVerifyCode(4);
		outputImage(200, 100, outputFile, verifyCode);
		return verifyCode;
	}
	...
	/**
	 * 输出默认随机验证码图片流,并返回验证码值
	 * 
	 * @param os
	 * @throws IOException
	 */
	public static String defaultVerifyImage(OutputStream os) throws IOException {
		String verifyCode = generateVerifyCode(4);
		outputImage(200, 100, os, verifyCode);
		return verifyCode;
	}
